...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Fulfillments, "fulfillment_jsonl_content_example", "fulfillment_response_expected_result"),
        (OrderRefunds, "order_refund_jsonl_content_example", "order_refund_response_expected_result"),
